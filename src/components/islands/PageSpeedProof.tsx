                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    >
                        <a
                            ...
                            className="inline-flex items-center gap-2 px-6 md:px-8 py-3 md:py-4 rounded-xl border-2 border-premium text-premium hover:bg-premium hover:text-white transition-all duration-300 text-base md:text-lg"
