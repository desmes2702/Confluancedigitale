...
interface Confluence404PageProps {
  onNavigate?: (page: string) => void;
}

export function Confluence404Page({ onNavigate }: Confluence404PageProps = {}) {
  ...
  return (
    <div className="min-h-screen bg-[#0D0D0D] flex items-center justify-center px-4 py-8 md:py-12 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10 px-4 sm:px-6">
        ...
        >
          <h1 className="text-[120px] sm:text-[180px] md:text-[240px] lg:text-[320px] leading-none tracking-tight text-transparent bg-clip-text bg-gradient-to-b from-[#D1A65E] via-[#D1A65E]/80 to-[#D1A65E]/40 select-none">
            404
          </h1>
        </motion.div>
        ...
        >
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-white mb-3 md:mb-4 leading-tight">
